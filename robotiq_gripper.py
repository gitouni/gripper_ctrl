...
class RobotiqGripper:
    ...
    def grasp_tighter(self, delta_pos:int = 2, speed:int = 1, force:int =1):
        pos = self.get_current_position()
        self.move(pos + delta_pos, speed, force)
...
if __name__ == "__main__":
    ...
    # gripper.activate()
    print(gripper._min_position, gripper._max_position, gripper._min_speed, gripper._max_speed, gripper._min_force, gripper._max_force)
    # gripper.move(228, 1, 1)
